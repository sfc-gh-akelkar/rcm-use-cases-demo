...
CREATE OR REPLACE DATABASE RCM_DENIAL_PREVENTION;
...
GRANT USAGE ON DATABASE RCM_DENIAL_PREVENTION TO ROLE SYSADMIN;
GRANT USAGE ON ALL SCHEMAS IN DATABASE RCM_DENIAL_PREVENTION TO ROLE SYSADMIN;
GRANT ALL PRIVILEGES ON ALL TABLES IN DATABASE RCM_DENIAL_PREVENTION TO ROLE SYSADMIN;
GRANT ALL PRIVILEGES ON ALL VIEWS IN DATABASE RCM_DENIAL_PREVENTION TO ROLE SYSADMIN;
...
SHOW DATABASES LIKE 'RCM_DENIAL_PREVENTION';
SHOW SCHEMAS IN DATABASE RCM_DENIAL_PREVENTION;
